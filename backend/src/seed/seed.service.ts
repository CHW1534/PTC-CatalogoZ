...
export class SeedService implements OnModuleInit {
  ...
  private async crearProductos(): Promise<Producto[]> {
    const productosData = [
      ...
      { nombre: 'Mocasin Casual', marca: 'Quirelli', modelo: 'MOC-300', color: 'Azul', talla: '26', tipo: TipoProducto.ZAPATO, descripcion: 'Mocasin casual sin agujetas' },
      { nombre: 'Mocasin Casual', marca: 'Quirelli', modelo: 'MOC-300', color: 'Azul', talla: '27', tipo: TipoProducto.ZAPATO, descripcion: 'Mocasin casual sin agujetas' },
      { nombre: 'Mocasin Casual', marca: 'Quirelli', modelo: 'MOC-300', color: 'Café', talla: '27', tipo: TipoProducto.ZAPATO, descripcion: 'Mocasin casual sin agujetas' },
      ...
      { nombre: 'Retro Classic', marca: 'Adidas', modelo: 'RTC-600', color: 'Blanco', talla: '27', tipo: TipoProducto.ZAPATO, descripcion: 'Tenis clasico estilo retro' },
      ...
      { nombre: 'Tote Bag Executive', marca: 'Michael Kors', modelo: 'TBE-100', color: 'Cafe', talla: 'G', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa grande ideal para trabajo' },
      { nombre: 'Tote Bag Executive', marca: 'Michael Kors', modelo: 'TBE-100', color: 'Vino', talla: 'G', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa grande ideal para trabajo' },
      ...
      { nombre: 'Crossbody Mini', marca: 'Guess', modelo: 'CBM-200', color: 'Negro', talla: 'CH', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa cruzada pequena para salir' },
      { nombre: 'Crossbody Mini', marca: 'Guess', modelo: 'CBM-200', color: 'Beige', talla: 'CH', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa cruzada pequena para salir' },
      { nombre: 'Clutch Elegante', marca: 'Coach', modelo: 'CLE-300', color: 'Dorado', talla: 'UNICA', tipo: TipoProducto.BOLSA, descripcion: 'Clutch de fiesta con cadena' },
      { nombre: 'Clutch Elegante', marca: 'Coach', modelo: 'CLE-300', color: 'Plateado', talla: 'UNICA', tipo: TipoProducto.BOLSA, descripcion: 'Clutch de fiesta con cadena' },
      { nombre: 'Clutch Elegante', marca: 'Coach', modelo: 'CLE-300', color: 'Negro', talla: 'UNICA', tipo: TipoProducto.BOLSA, descripcion: 'Clutch de fiesta con cadena' },
      ...
      { nombre: 'Mochila Casual', marca: 'Kipling', modelo: 'MCH-400', color: 'Morado', talla: 'M', tipo: TipoProducto.BOLSA, descripcion: 'Mochila ligera para uso diario' },
      { nombre: 'Mochila Casual', marca: 'Kipling', modelo: 'MCH-400', color: 'Negro', talla: 'M', tipo: TipoProducto.BOLSA, descripcion: 'Mochila ligera para uso diario' },
      { nombre: 'Shopper Weekend', marca: 'Fossil', modelo: 'SHW-500', color: 'Cafe', talla: 'XG', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa grande para viajes cortos' },
      { nombre: 'Shopper Weekend', marca: 'Fossil', modelo: 'SHW-500', color: 'Negro', talla: 'XG', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa grande para viajes cortos' },
      ...
      { nombre: 'Portafolio Business', marca: 'Samsonite', modelo: 'PFB-100', color: 'Cafe', talla: 'G', tipo: TipoProducto.BOLSA, descripcion: 'Portafolio ejecutivo con compartimento laptop' },
      ...
      { nombre: 'Messenger Casual', marca: 'Fossil', modelo: 'MSG-200', color: 'Negro', talla: 'M', tipo: TipoProducto.BOLSA, descripcion: 'Bolsa messenger estilo casual' },
      { nombre: 'Backpack Tech', marca: 'Tumi', modelo: 'BPT-300', color: 'Negro', talla: 'G', tipo: TipoProducto.BOLSA, descripcion: 'Mochila con multiples compartimentos tecnologicos' },
